...
/**
 * Servlet implementation class SavedData_1_servlet
 */
@WebServlet("/SavedData_1_servlet")
public class SavedData_1_servlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		userDao.insert_1st_user(userBean);
