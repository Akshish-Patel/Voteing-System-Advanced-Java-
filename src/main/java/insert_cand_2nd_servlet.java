...
/**
 * Servlet implementation class insert_cand_2nd_servlet
 */
@WebServlet("/insert_cand_2nd_servlet")
public class insert_cand_2nd_servlet extends HttpServlet 
{
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		candDao.insert_2nd_cand(candBean);
