...
/**
 * Servlet implementation class insert_cand_3rd_servlet
 */
@WebServlet("/insert_cand_3rd_servlet")
public class insert_cand_3rd_servlet extends HttpServlet 
{
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		candDao.insert_3rd_cand(candBean);
