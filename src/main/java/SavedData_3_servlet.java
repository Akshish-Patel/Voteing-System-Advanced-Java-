...
/**
 * Servlet implementation class SavedData_3_servlet
 */
@WebServlet("/SavedData_3_servlet")
public class SavedData_3_servlet extends HttpServlet {
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		userDao.insert_3rd_user(userBean);
