...
<div class="container-fluid" id="cont-3">
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 style="margin-top: 25px;">Candidate</h2>
                    </div>
                </div>
            </div>
        </section>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <a href="user_cand_1_servlet"><button style="margin-top:80px;" class="btn-special-2">1<sup>st</sup> Year </button></a>
            </div>
            <div class="col-md-12">
            <a href="user_cand_2_servlet"><button style="margin-top:80px;" class="btn-special-2">2<sup>nd</sup> Year </button></a>
            </div>
            <div class="col-md-12">
            <a href="user_cand_3_servlet"><button style="margin-top:80px; " class="btn-special-2">3<sup>rd</sup> Year </button></a>
            </div>
        </div>
    </div>
