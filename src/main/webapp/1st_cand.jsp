...
<div class="container">
         ...
         <%
         	ArrayList<candidateBean> cand_1st = (ArrayList<candidateBean>)request.getAttribute("cand_1st");
         	
         	for(int i=0; i<cand_1st.size(); i++)
         	{
         		candidateBean candBean = cand_1st.get(i);
%>
        <!-- Card Start -->
          <div class="col-md-3 " style=" margin-left:25px; padding-top: 30px;">
                <div class="card" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    ...
                    <a href="confirmation_1" class="btn btn-primary">Vote Now</a>
                  </div>
                </div>
              </div>
              <%} %>
