...
<div class="container">
         ...
         <%
         	ArrayList<candidateBean> cand_2nd = (ArrayList<candidateBean>)request.getAttribute("cand_2nd");
         	
         	for(int i=0; i<cand_2nd.size(); i++)
         	{
         		candidateBean candBean = cand_2nd.get(i);
%>
        <!-- Card Start -->
          <div class="col-md-3 " style=" margin-left:25px; padding-top: 30px;">
                <div class="card" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    <h2 class="card-title"><%=candBean.getName()%></h2>
                    <p class="card-text"><%=candBean.getBranch() %></p>
                    <a href="confirmation_2" class="btn btn-primary">Vote Now</a>
                  </div>
                </div>
              </div>
              <%} %>
