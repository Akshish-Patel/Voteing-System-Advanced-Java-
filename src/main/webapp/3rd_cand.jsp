...
<div class="container">
         ...
         <%
         	ArrayList<candidateBean> cand_3rd = (ArrayList<candidateBean>)request.getAttribute("cand_3rd");
         	
         	for(int i=0; i<cand_3rd.size(); i++)
         	{
         		candidateBean candBean = cand_3rd.get(i);
%>
        <!-- Card Start -->
          <div class="col-md-3 " style=" margin-left:25px; padding-top: 30px;">
                <div class="card" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    ...
                    <a href="confirmation_3" class="btn btn-primary">Vote Now</a>
                  </div>
                </div>
              </div>
              <%} %>
